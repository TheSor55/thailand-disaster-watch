...
export const MAJOR_DAMS: readonly DamTelemetry[] = [
  // ภาคเหนือ
  {
    ...
    provider: 'EGAT',
    attribution: 'ข้อมูลโทรมาตรเขื่อน กฟผ. / สสน. (HII)',
  },
  {
    damId: 'dam-sirikit',
  ...
  },
  {
    ...
    updatedAt: new Date().toISOString(),
    provider: 'RID',
    attribution: 'ข้อมูลโทรมาตร กรมชลประทาน (RID) / สสน. (HII)',
  },
