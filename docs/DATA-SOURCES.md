...
| RainViewer | Radar precipitation reflectance | [Weather Maps API](https://www.rainviewer.com/api/weather-maps-api.html) | Global mosaic (TMD radar ingested); 10m historical cadence | Free public API (10k req/day); global CDN tile cache | Free non-commercial use with mandatory attribution: "Weather radar data by RainViewer" + link | `PENDING — CONTROLLED PREVIEW ONLY` |
