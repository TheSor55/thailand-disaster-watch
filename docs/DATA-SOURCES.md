...
| Royal Irrigation Department (RID) | River, reservoir, irrigation operations | [Direct reservoir JSON API](https://app.rid.go.th/reservoir/api/reservoir/public) & [Dam public API](https://app.rid.go.th/reservoir/api/dam/public) | Thailand; daily updates; observed timestamps are nested in telemetry fields | Public access; rate limits & SLA not verified | Dataset-specific license and attribution must be confirmed from RID | `PENDING` |
