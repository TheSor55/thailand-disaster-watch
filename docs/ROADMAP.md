...
| 3.4 | Free Radar Source Feasibility & Controlled Radar Layer | Phase 3.3 review/approval | **Controlled Radar Layer: COMPLETE. Production Approval: PENDING.** RainViewer candidate audited, domain/worker adapter added, controlled MapLibre raster layer with timestamps and mandatory attribution, default OFF, zero nowcasting. |
